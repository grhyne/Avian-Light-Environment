...
spName2 <- "Sclerurus rufigularis"
rawData2 <- as.data.frame(read.csv("./Species_Data/SCRU_geo.csv", header = TRUE))

#Band dates of second species
bandDate2 <- "2018-08-07"
recapDate2 <- "2019-06-17"
```
...
t.test(finalData$mean, finalData2$mean)
